        ...
        <div class="register-box">
            <div class="card">
                ...
                <h5><i class="icon fas fa-check"></i> Succes</h5>';
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="ulanggi_password" value="<?= set_value('ulanggi_password') ?>" class="form-control" placeholder="Ulanggi Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-lock"></span>
                            </div>
                    ...
                    <p>Sudah Punya Akun..?<a href="<?= base_url('pelanggan/login') ?>" class="text-center"> Masuk</a></p>
                </div>
                <!-- /.form-box -->
            </div><!-- /.card -->
        </div>
