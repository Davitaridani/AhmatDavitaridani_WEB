                ...
                <tbody>
                    ...
                    foreach ($barang as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('barang/edit/' . $value->id_barang) ?>" class="btn btn-danger btn-sm"><i class="fas fa-edit"></i>
                                </a>
                                <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#delete<?= $value->id_barang ?>"><i class="fas fa-trash"></i>
                                </button>
                            </td>
                        </tr>
                    <?php } ?>
