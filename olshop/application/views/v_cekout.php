...
<div class="invoice p-3 mb-3">
    ...
    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="hp_penerima" class="form-control" required></input>
                    </div>
                </div>
            </div>
        ...
        <div class="col-4">
            ...
            <div class="table-responsive">
                <table class="table">
                    <tr>
                        <th style="width:50%">Grannd Total :</th>
    ...
    <div class="row no-print">
        <div class="col-12">
            <a href="<?= base_url('belanja') ?>" class="btn btn-primary"><i class="fas fa-backward"></i> Kembali Ke Keranjang</a>
...
<script>
    $(document).ready(function() {
        ...
        $("select[name=expedisi]").on("change", function() {
            ...
            //mendaptkan id kota tujuan/terpilih
        ...
        $("select[name=paket]").on("change", function() {
            //untuk menampilkan harga ongkir
