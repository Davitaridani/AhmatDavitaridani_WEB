    ...
    <div class="card card-danger">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class=" col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_telepon" class="form-control" value="<?= $setting->no_telepon ?>" required></input>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="alamat_toko" class="form-control" value="<?= $setting->alamat_toko ?>" required></input>
            </div>
            <div class="form-group">
