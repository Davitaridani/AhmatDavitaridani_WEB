    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambar/no foto.jpg') ?>" id="gambar_load" width="160px">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <a href="<?= base_url('gambarbarang') ?>" class="btn btn-primary btn-sm">Kembali</a>
            </div>
            ...
            <div class="row">
                <?php foreach ($gambar as $key => $value) { ?>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <img src="<?= base_url('assets/gambarbarang/' . $value->gambar) ?>" id="gambar_load" width="200px" height="180px">
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <h5>Apakah Anda Yakin Ingin Mengahapus Gambar Ini...? </h5>
